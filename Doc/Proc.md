...
io4=>inputoutput: "按下'NO'"
io5=>inputoutput: "按下'NO'"
io6=>inputoutput: "按下'NO'"
c1=>condition: "==0"
c2=>condition: "==1"
c3=>condition: "==2"
...
c1(yes)->sub10->io4(right)->op3
c2(yes)->sub11->io5(right)->op3
c3(yes)->sub12->io6(right)->op3
```
***
...
c1(yes)->op1->io2->op2->c6(yes)->op3->op1
c6(no)->op1
c7(no)->op4
c2(yes)->op4->io3->io4->c7(yes)->op5->c4(no)->op6
...
io4=>inputoutput: "输入'yes'键"
io5=>inputoutput: "输入房间号"
io6=>inputoutput: "输入密码"
io7=>inputoutput: "输入管理员密码"
io8=>inputoutput: "输入'yes'键"
c1=>condition: "==0"
c2=>condition: "==1"
c3=>condition: "房间号已存在?"
c4=>condition: 用户匹配成功?
sub->io1->c1(no)->c2(no)->io1
c1(yes)->io2->io3->io4->c4(yes)->op->io8->io2
c4(no)->io2
c2(yes)->io5->io6->c3(yes)->io7->op1(right)->io1
c3(no)->op1(right)->io1
```
